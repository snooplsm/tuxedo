...
//	private static String TAG = "DATESLIDER";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button todayButton = (Button) findViewById(R.id.dateSliderTodayButton);
		todayButton.setOnClickListener(todayButtonClickListener);
		todayButton.setVisibility(isTodayVisible() ? View.VISIBLE : View.GONE);
		arrangeScroller(null);
	}
	
	protected boolean isTodayVisible() {
		return true;
	}
	...
	private android.view.View.OnClickListener todayButtonClickListener = new android.view.View.OnClickListener() {
		public void onClick(View v) {
			if(onDateSetListener!=null) {
				onDateSetListener.onDateSet(DateSlider.this, Calendar.getInstance());
			}
			dismiss();
		}
	}; 
